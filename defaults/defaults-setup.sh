...
# --- ショートカットキーの変更 ---
# Appleメニューの「Force Quit...」を⌘⌥`に割り当てる
# 標準の⌘⌥Escは維持し、同じ操作を別のキーからも呼び出せるようにする
set_user_dict_entry NSGlobalDomain NSUserKeyEquivalents \
  "Force Quit..." "" '@~`' '@~`'
...
python3 "$SCRIPT_DIR/configure-powerpoint-shortcuts.py"
  powerpoint_status=$?
